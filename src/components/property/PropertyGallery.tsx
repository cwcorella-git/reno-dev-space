...
export function PropertyGallery() {
  ...
  if (loading) {
    return (
      <div className="fixed bottom-40 left-0 right-0 z-35">
  ...
  if (properties.length === 0) {
    return (
      <>
        <div className="fixed bottom-40 left-0 right-0 z-35 bg-gradient-to-r from-slate-900/95 via-gray-900/95 to-slate-900/95 backdrop-blur-sm border-t border-white/10">
