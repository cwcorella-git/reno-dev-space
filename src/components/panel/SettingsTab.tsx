    ...
    <div className="max-h-[400px] overflow-y-auto">
      ...
      {!confirmAction && (
        <div className="p-4 space-y-4">
          ...
          {isAdmin && (
            <>
              <div className="pt-3 border-t-2 border-amber-600/30">
          ...
          {/* Sign out - only show if not in admin section (which has its own bottom) */}
          {!isAdmin && (
      ...
      {/* Sign out for admin (after content section) */}
      {!confirmAction && isAdmin && (
        <div className="p-4 border-t border-white/10">
          <button onClick={handleLogout} className="w-full px-3 py-2 text-sm text-red-400 hover:bg-white/5 rounded flex items-center justify-center gap-2">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
            </svg>
            Sign Out
